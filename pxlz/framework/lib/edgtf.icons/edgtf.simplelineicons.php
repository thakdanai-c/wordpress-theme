...
class PxlzEdgefSimpleLineIcons implements iPxlzEdgefIconCollection
{
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            '' => '',
            'icon-social-behance' => esc_html__('Behance', 'pxlz'),
            'icon-social-dribbble' => esc_html__('Dribbble', 'pxlz'),
            'icon-social-dropbox' => esc_html__('Dropbox', 'pxlz'),
            'icon-social-facebook' => esc_html__('Facebook', 'pxlz'),
            'icon-social-foursquare' => esc_html__('Foursquare', 'pxlz'),
            'icon-social-github' => esc_html__('Github', 'pxlz'),
            'icon-social-gplus' => esc_html__('Google Plus', 'pxlz'),
            'icon-social-instagram' => esc_html__('Instagram', 'pxlz'),
            'icon-social-linkedin' => esc_html__('LinkedIn', 'pxlz'),
            'icon-social-pintarest' => esc_html__('Pinterest', 'pxlz'),
            'icon-social-reddit' => esc_html__('Reddit', 'pxlz'),
            'icon-social-skype' => esc_html__('Skype', 'pxlz'),
            'icon-social-soundcloud' => esc_html__('Soundcloud', 'pxlz'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'pxlz'),
            'icon-social-spotify' => esc_html__('Spotify', 'pxlz'),
            'icon-social-tumblr' => esc_html__('Tumblr', 'pxlz'),
            'icon-social-twitter' => esc_html__('Twitter', 'pxlz'),
            'icon-social-youtube' => esc_html__('Youtube', 'pxlz')
        );
    }
