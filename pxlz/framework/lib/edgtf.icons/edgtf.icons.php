...
/*
  Class: PxlzEdgefIconCollections
...
class PxlzEdgefIconCollections
{
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new PxlzEdgefIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new PxlzEdgefIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new PxlzEdgefIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new PxlzEdgefLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('linear_icons', new PxlzEdgefLinearIcons('Linear Icons', 'linear_icon'));
        $this->addIconCollection('simple_line_icons', new PxlzEdgefSimpleLineIcons('Simple Line Icons', 'simple_line_icon'));
        $this->addIconCollection('dripicons', new PxlzEdgefDripicons('Dripicons', 'dripicon'));
    }
    ...
    public function getIconsMetaBoxOrOption($attributes) {
        ...
        $options = array(
            'font_awesome' => esc_html__('Font Awesome', 'pxlz'),
            'font_elegant' => esc_html__('Font Elegant', 'pxlz'),
            'ion_icons' => esc_html__('Ion Icons', 'pxlz'),
            'simple_line_icons' => esc_html__('Simple Line Icons', 'pxlz')
        );
        if ($scope == 'regular') {
            $options = array(
                'font_awesome' => esc_html__('Font Awesome', 'pxlz'),
                'font_elegant' => esc_html__('Font Elegant', 'pxlz'),
                'ion_icons' => esc_html__('Ion Icons', 'pxlz'),
                'linea_icons' => esc_html__('Linea Icons', 'pxlz'),
                'linear_icons' => esc_html__('Linear Icons', 'pxlz'),
                'simple_line_icons' => esc_html__('Simple Line Icons', 'pxlz'),
                'dripicons' => esc_html__('Dripicons', 'pxlz')
            );
        }
        ...
        foreach ($icon_collections as $collection_key => $collection_object) {
            ...
            $edgtf_icon_pack_container = pxlz_edgtf_add_admin_container(
                array(
                    'parent' => $parent,
                    'name' => $name . '_' . $collection_object->param . '_container',
                    'hidden_property' => $name,
                    'hidden_value' => '',
                    'hidden_values' => $edgtf_icon_hide_values,
    ...
    public function getVCParamsArray($iconPackDependency = array(), $iconCollectionPrefix = "", $emptyIconPack = false) {
        ...
        $iconPackParams = array(
            'type' => 'dropdown',
            'heading' => esc_html__('Icon Pack', 'pxlz'),
    ...
    public function getIconWidgetParamsArray() {
        ...
        $iconPackParams[] = array(
            'type' => 'dropdown',
            'title' => esc_html__('Icon Pack', 'pxlz'),
            'name' => 'icon_pack',
            'options' => array(
                'font_awesome' => esc_html__('Font Awesome', 'pxlz'),
                'font_elegant' => esc_html__('Font Elegant', 'pxlz'),
    ...
    public function getIconCollectionIcons(iPxlzEdgefIconCollection $collection) {
...
if (!function_exists('pxlz_edgtf_activate_theme_icons')) {
    function pxlz_edgtf_activate_theme_icons() {
        global $pxlz_edgtf_IconCollections;
        $pxlz_edgtf_IconCollections = PxlzEdgefIconCollections::get_instance();
    }

    add_action('after_setup_theme', 'pxlz_edgtf_activate_theme_icons');
}