...
/*
   Class: PxlzEdgefMultipleImages
   A class that initializes Edge Multiple Images
*/

class PxlzEdgefMultipleImages implements iPxlzEdgefRender
{
    private $name;
    private $label;
    private $description;
    ...
    function __construct($name, $label = "", $description = "") {
        ...
        $pxlz_edgtf_Framework->edgtMetaBoxes->addOption($this->name, "");
    }
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="edgtf-gallery-uploader">
                                <a class="edgtf-gallery-upload-btn btn btn-sm btn-primary" href="javascript:void(0)"><?php esc_html_e('Upload', 'pxlz'); ?></a>
                                <a class="edgtf-gallery-clear-btn btn btn-sm btn-default pull-right" href="javascript:void(0)"><?php esc_html_e('Remove All', 'pxlz'); ?></a>
							</div>
...
/*
   Class: PxlzEdgefImagesVideos
   A class that initializes Edge Images Videos
*/

class PxlzEdgefImagesVideos implements iPxlzEdgefRender
{
    private $label;
    private $description;
    ...
    public function render($factory) {
            ...
            <div class="edgtf-page-form-section">
                ...
                <div class="edgtf-section-content">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-2">
                                <em class="edgtf-field-description"><?php esc_html_e('Order Number', 'pxlz'); ?></em>
                        ...
                        <div class="row next-row">
                            <div class="col-lg-12">
                                <em class="edgtf-field-description"><?php esc_html_e('Image', 'pxlz'); ?></em>
                                <div class="edgtf-media-uploader">
                                    <div style="display: none" class="edgtf-media-image-holder">
                                        <img src="" alt="<?php esc_attr_e('Image thumbnail', 'pxlz'); ?>" class="edgtf-media-image img-thumbnail"/>
                                    </div>
                        ...
                        <div class="row next-row">
                            <div class="col-lg-3">
                                <em class="edgtf-field-description"><?php esc_html_e('Video Type', 'pxlz'); ?></em>
                                <select class="form-control edgtf-form-element edgtf-portfoliovideotype" name="portfoliovideotype_x" id="portfoliovideotype_x">
                                    <option value=""></option>
                                    <option value="youtube"><?php esc_html_e('YouTube', 'pxlz'); ?></option>
                                    <option value="vimeo"><?php esc_html_e('Vimeo', 'pxlz'); ?></option>
                                    <option value="self"><?php esc_html_e('Self Hosted', 'pxlz'); ?></option>
                                </select>
                            </div>
                            <div class="col-lg-3">
                                <em class="edgtf-field-description"><?php esc_html_e('Video ID', 'pxlz'); ?></em>
                                <input type="text" class="form-control edgtf-input edgtf-form-element" id="portfoliovideoid_x" name="portfoliovideoid_x"/>
                            </div>
                        </div>
                        <div class="row next-row">
                            <div class="col-lg-12">
                                <em class="edgtf-field-description"><?php esc_html_e('Video image', 'pxlz'); ?></em>
                                <div class="edgtf-media-uploader">
                                    <div style="display: none" class="edgtf-media-image-holder">
                                        <img src="" alt="<?php esc_attr_e('Image thumbnail', 'pxlz'); ?>" class="edgtf-media-image img-thumbnail"/>
                                    </div>
                        ...
                        <div class="row next-row">
                            <div class="col-lg-4">
                                <em class="edgtf-field-description"><?php esc_html_e('Video mp4', 'pxlz'); ?></em>
                                <input type="text" class="form-control edgtf-input edgtf-form-element" id="portfoliovideomp4_x" name="portfoliovideomp4_x"/>
                            </div>
                        </div>
                        <div class="row next-row">
                            <div class="col-lg-12">
                                <a class="edgtf_remove_image btn btn-sm btn-primary" href="/" onclick="javascript: return false;"><?php esc_html_e('Remove portfolio image/video', 'pxlz'); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        if (is_array($portfolio_images) && count($portfolio_images) > 1 && pxlz_edgtf_core_plugin_installed()) {
                                    ...
                                    <div class="edgtf-media-uploader">
                                        <div<?php if (stripslashes($portfolio_image['portfolioimg']) == false) { ?> style="display: none"<?php } ?> class="edgtf-media-image-holder">
                                            <img src="<?php if (stripslashes($portfolio_image['portfolioimg']) == true) {
                                                echo esc_url(pxlz_edgtf_get_attachment_thumb_url(stripslashes($portfolio_image['portfolioimg'])));
                            ...
                            <div class="row next-row">
                                <div class="col-lg-3">
                                    ...
                                    <select class="form-control edgtf-form-element edgtf-portfoliovideotype" name="portfoliovideotype[]" id="portfoliovideotype_<?php echo esc_attr($no); ?>">
                                        ...
                                        } ?> value="youtube"><?php esc_html_e('YouTube', 'pxlz'); ?></option>
                                        <option <?php if ($portfolio_image['portfoliovideotype'] == "vimeo") {
                                            echo "selected='selected'";
                                        } ?> value="vimeo"><?php esc_html_e('Vimeo', 'pxlz'); ?></option>
                                        <option <?php if ($portfolio_image['portfoliovideotype'] == "self") {
                                            echo "selected='selected'";
                                        } ?> value="self"><?php esc_html_e('Self Hosted', 'pxlz'); ?></option>
                                    </select>
                                </div>
                                <div class="col-lg-3">
                                    <em class="edgtf-field-description"><?php esc_html_e('Video ID', 'pxlz'); ?></em>
                                    ...
                                    <div class="edgtf-media-uploader">
                                        <div<?php if (stripslashes($portfolio_image['portfoliovideoimage']) == false) { ?> style="display: none"<?php } ?> class="edgtf-media-image-holder">
                                            <img src="<?php if (stripslashes($portfolio_image['portfoliovideoimage']) == true) {
                                                echo esc_url(pxlz_edgtf_get_attachment_thumb_url(stripslashes($portfolio_image['portfoliovideoimage'])));
                                            } ?>" alt="<?php esc_attr_e('Image thumbnail', 'pxlz'); ?>" class="edgtf-media-image img-thumbnail"/>
                                        </div>
                                        <div style="display: none" class="edgtf-media-meta-fields">
        ...
        ?>
        <br/>
        <a class="edgtf_add_image btn btn-sm btn-primary" onclick="javascript: return false;" href="/"><?php esc_html_e('Add portfolio image/video', 'pxlz'); ?></a>
        <?php
    }
}
...
class PxlzEdgefImagesVideosFramework implements iPxlzEdgefRender
{
    private $label;
    private $description;
    ...
    public function render($factory) {
        ...
        <div class="edgtf-hidden-portfolio-images" style="display: none">
            <div class="edgtf-portfolio-toggle-holder">
                <div class="edgtf-portfolio-toggle edgtf-toggle-desc">
                    ...
                    <span class="edgtf-toggle-inner"><?php esc_html_e('Image - ', 'pxlz'); ?>
                        <em><?php esc_html_e('Order Number', 'pxlz'); ?></em></span>
                </div>
        ...
        <div class="edgtf-hidden-portfolio-videos" style="display: none">
            <div class="edgtf-portfolio-toggle-holder">
                <div class="edgtf-portfolio-toggle edgtf-toggle-desc">
                    ...
                    <span class="edgtf-toggle-inner"><?php esc_html_e('Video - ', 'pxlz'); ?>
                        <em><?php esc_html_e('Order Number', 'pxlz'); ?></em></span>
                </div>
                <div class="edgtf-portfolio-toggle edgtf-portfolio-control">
                    <span class="toggle-portfolio-media"><i class="fa fa-caret-up"></i></span>
                    ...
                    <div class="edgtf-section-content">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="edgtf-media-uploader">
                                        <em class="edgtf-field-description"><?php esc_html_e('Cover Video Image', 'pxlz'); ?></em>
                                        <div style="display: none" class="edgtf-media-image-holder">
                                            <img src="" alt="<?php esc_attr_e('Image thumbnail', 'pxlz'); ?>" class="edgtf-media-image img-thumbnail">
                                        </div>
                                        <div style="display: none" class="edgtf-media-meta-fields">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="row next-row">
                                        ...
                                        <div class="col-lg-2 edgtf-video-id-holder">
                                            <em class="edgtf-field-description" id="videoId"><?php esc_html_e('Video ID', 'pxlz'); ?></em>
                                            <input type="text" class="form-control edgtf-input edgtf-form-element" id="portfoliovideoid_x" name="portfoliovideoid_x">
                                        </div>
                                    </div>
        ...
        <div class="edgtf-portfolio-add">
            <a class="edgtf-add-image btn btn-sm btn-primary" href="#"><i class="fa fa-camera"></i><?php esc_html_e('Add Image', 'pxlz'); ?>
            </a>
            <a class="edgtf-add-video btn btn-sm btn-primary" href="#"><i class="fa fa-video-camera"></i><?php esc_html_e('Add Video', 'pxlz'); ?>
            </a>
            <a class="edgtf-toggle-all-media btn btn-sm btn-default pull-right" href="#"><?php esc_html_e('Expand All', 'pxlz'); ?></a>
        </div>
        <?php
    }
}

class PxlzEdgefTwitterFramework implements iPxlzEdgefRender
{
    public function render($factory) {
        ...
        if (!empty($_GET['oauth_token']) && !empty($_GET['oauth_verifier'])) {
            ...
            if ($responseObj->status) {
                $message = esc_html__('You have successfully connected with your Twitter account. If you have any issues fetching data from Twitter try reconnecting.', 'pxlz');
            } else {
                $message = $responseObj->message;
            }
        }

        $buttonText = $twitterApi->hasUserConnected() ? esc_html__('Re-connect with Twitter', 'pxlz') : esc_html__('Connect with Twitter', 'pxlz');
        ?>
        <?php if ($message !== '') { ?>
        ...
        <div class="edgtf-page-form-section" id="edgtf_enable_social_share">
            <div class="edgtf-field-desc">
                <h4><?php esc_html_e('Connect with Twitter', 'pxlz'); ?></h4>
                <p><?php esc_html_e('Connecting with Twitter will enable you to show your latest tweets on your site', 'pxlz'); ?></p>
            </div>
            <div class="edgtf-section-content">
                <div class="container-fluid">
                    <div class="row">
...
class PxlzEdgefInstagramFramework implements iPxlzEdgefRender
{
    public function render($factory) {
        ...
        if (!get_option('edgtf_instagram_code')) {
            ...
            if (!empty($_GET['code'])) {
                ...
                $message = esc_html__('You have successfully connected with your Instagram account. If you have any issues fetching data from Instagram try reconnecting.', 'pxlz');
        ...
        $buttonText = $instagram_api->hasUserConnected() ? esc_html__('Re-connect with Instagram', 'pxlz') : esc_html__('Connect with Instagram', 'pxlz');
        ?>
        <?php if ($message !== '') { ?>
            <div class="alert alert-success" style="margin-top: 20px;">
                <span><?php echo esc_html($message); ?></span>
        ...
        <div class="edgtf-page-form-section" id="edgtf_enable_social_share">
            <div class="edgtf-field-desc">
                <h4><?php esc_html_e('Connect with Instagram', 'pxlz'); ?></h4>
                <p><?php esc_html_e('Connecting with Instagram will enable you to show your latest photos on your site', 'pxlz'); ?></p>
            </div>
            <div class="edgtf-section-content">
                <div class="container-fluid">
                    <div class="row">
...
class PxlzEdgefOptionsFramework implements iPxlzEdgefRender
{
    private $label;
    private $description;
    ...
    public function render($factory) {
        ...
        <div class="edgtf-portfolio-additional-item-holder" style="display: none">
            <div class="edgtf-portfolio-toggle-holder">
                <div class="edgtf-portfolio-toggle edgtf-toggle-desc">
                    <span class="number">1</span>
                    <span class="edgtf-toggle-inner"><?php esc_html_e('Additional Sidebar Item', 'pxlz'); ?><em><?php esc_html_e('(Order Number, Item Title)', 'pxlz'); ?></em></span>
                </div>
                <div class="edgtf-portfolio-toggle edgtf-portfolio-control">
                    ...
                    <div class="edgtf-section-content">
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-lg-10">
                                    <em class="edgtf-field-description"><?php esc_html_e('Item Title', 'pxlz'); ?></em>
                                    <input type="text" class="form-control edgtf-input edgtf-form-element" id="optionLabel_x" name="optionLabel_x">
                                </div>
                            </div>
                            <div class="row next-row">
                                <div class="col-lg-12">
                                    <em class="edgtf-field-description"><?php esc_html_e('Item Text', 'pxlz'); ?></em>
                                    <textarea class="form-control edgtf-input edgtf-form-element" id="optionValue_x" name="optionValue_x"></textarea>
                                </div>
                            </div>
                            <div class="row next-row">
                                <div class="col-lg-12">
                                    <em class="edgtf-field-description"><?php esc_html_e('Enter Full URL for Item Text Link', 'pxlz'); ?></em>
        ...
        if (is_array($portfolios) && count($portfolios) > 1 && pxlz_edgtf_core_plugin_installed()) {
        ...
        while (isset($portfolios[$no - 1])) {
            ...
            <div class="edgtf-portfolio-additional-item" rel="<?php echo esc_attr($no); ?>">
                <div class="edgtf-portfolio-toggle-holder">
                    <div class="edgtf-portfolio-toggle edgtf-toggle-desc">
                        <span class="number"><?php echo esc_html($no); ?></span>
                        <span class="edgtf-toggle-inner"><?php esc_html_e('Additional Sidebar Item - ', 'pxlz'); ?>
        ...
        <div class="edgtf-portfolio-add">
            <a class="edgtf-add-item btn btn-sm btn-primary" href="#"><?php esc_html_e('Add New Item', 'pxlz'); ?></a>
            <a class="edgtf-toggle-all-item btn btn-sm btn-default pull-right" href="#"><?php esc_html_e('Expand All', 'pxlz'); ?></a>
        </div>
        <?php
    }
}

class PxlzEdgefRepeater implements iPxlzEdgefRender
{
    private $label;
    private $description;
    private $name;
    ...
    function __construct($fields, $name, $label = '', $description = '', $button_text = '') {
        ...
        $this->name = $name;
        $this->num_of_rows = 1;
        $this->button_text = !empty($button_text) ? $button_text : esc_html__('Add New Item', 'pxlz');
        ...
        foreach ($this->fields as $field) {
            ...
            $pxlz_edgtf_Framework->edgtMetaBoxes->addOption($this->fields[$counter]['name'], $this->fields[$counter]['default_value']);
            $counter++;
        }
    }
...
class PxlzEdgefTableRepeater implements iPxlzEdgefRender
{
    private $label;
    private $description;
    private $name;
    ...
    function __construct($fields, $name, $label = '', $description = '', $button_text = '') {
        ...
        $this->name = $name;
        $this->num_of_rows = 1;
        $this->button_text = !empty($button_text) ? $button_text : esc_html__('Add New', 'pxlz');
    ...
    public function render($factory) {
        ...
        <div class="edgtf-repeater-wrapper edgtf-question-answers">
            <table class="edgtf-repeater-fields-holder edgtf-table-layout <?php echo esc_attr($sortable_class); ?> clearfix">
                <thead>
                <tr>
                    <th><?php esc_html_e('Order', 'pxlz') ?></th>
                    <?php foreach ($this->fields as $field) { ?>
                        <th><?php echo esc_html($field['th']); ?></th>
                    <?php } ?>
                    <th><?php esc_html_e('Remove', 'pxlz') ?></th>
                </tr>
                </thead>
...
class PxlzEdgefRowRepeater implements iPxlzEdgefRender
{
    private $label;
    private $description;
    private $name;
...
class PxlzEdgefParentChildRepeater implements iPxlzEdgefRender
{
    private $num_of_rows;
    private $name;
    private $label;
...
class PxlzEdgefFieldAddress extends PxlzEdgefFieldType
{
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <?php endif; ?>
                            ...
                            <button id="find" class="btn btn-primary"><?php esc_html_e('Place the pin on the map', 'pxlz'); ?></button>
                            <a id="reset" href="#" style="display:none;"><?php esc_html_e('Reset Marker', 'pxlz'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
