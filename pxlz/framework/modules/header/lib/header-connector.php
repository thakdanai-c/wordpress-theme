...
namespace PxlzEdgef\Modules\Header\Lib;
/**
 * Class PxlzEdgefHeaderConnector
 *
...
class PxlzEdgefHeaderConnector
{
    ...
    public function connect($config = array()) {
        do_action('pxlz_edgtf_pre_header_connect');
        ...
        if (!empty($config['affect_content'])) {
            add_filter('pxlz_edgtf_content_elem_style_attr', array($this, 'contentMarginFilter'));
        }

        if (!empty($config['affect_title'])) {
            add_filter('pxlz_edgtf_title_content_padding', array($this, 'titlePaddingFilter'));
        }

        do_action('pxlz_edgtf_after_header_connect');
    }
     ...
     *
     * Hooks to pxlz_edgtf_title_content_padding filter
     *
     * @return int
     */
