...
if (!class_exists('PxlzEdgefFullscreenNavigationWalker')) {
    class PxlzEdgefFullscreenNavigationWalker extends Walker_Nav_Menu
    {
        ...
        function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
            ...
            if ($item->hide == "") {
                ...
                if ($args->has_children) {
                    $item_output .= '<i class="edgtf-fullscreen-menu-arrow ion-ios-arrow-down"></i>';
                }
                $item_output .= '</a>';
            }
