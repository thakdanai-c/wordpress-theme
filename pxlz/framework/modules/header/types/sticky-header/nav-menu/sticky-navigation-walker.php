...
if (!class_exists('PxlzEdgefStickyNavigationWalker')) {
    class PxlzEdgefStickyNavigationWalker extends Walker_Nav_Menu
    {
        ...
        function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
            ...
            if ($item->hide == "") {
                ...
                if ($args->has_children && $depth == 0) {
                    $item_output .= '<i class="edgtf-menu-arrow ion-ios-arrow-down"></i>';
                }
