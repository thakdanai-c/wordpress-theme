<?php
if ($show_header_top) {
    do_action('pxlz_edgtf_before_header_top');
    ?>
    ...
    <div class="edgtf-top-bar">
        <?php do_action('pxlz_edgtf_after_header_top_html_open'); ?>
    ...
    <?php endif; ?>
        ...
        <?php do_action('pxlz_edgtf_before_header_top_html_close'); ?>
    </div>

    <?php do_action('pxlz_edgtf_after_header_top');
}