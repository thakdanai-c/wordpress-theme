...
$blog_list_image_id = !empty($image_meta) && pxlz_edgtf_blog_item_has_link() ? pxlz_edgtf_get_attachment_id_from_url($image_meta) : '';
?>

<?php if ($has_featured) { ?>
    <div class="edgtf-post-image">
        <?php if (pxlz_edgtf_blog_item_has_link()) { ?>
    ...
    <?php } ?>
        <?php do_action('pxlz_edgtf_action_blog_inside_image_tag') ?>
    </div>
<?php } ?>