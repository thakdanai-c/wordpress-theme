...
class PxlzEdgefIconWidget extends PxlzEdgefWidget
{
    public function __construct() {
        parent::__construct(
            'edgtf_icon_widget',
            esc_html__('Edge Icon Widget', 'pxlz'),
            array('description' => esc_html__('Add icons to widget areas', 'pxlz'))
        );
    ...
    protected function setParams() {
        $this->params = array_merge(
            pxlz_edgtf_icon_collections()->getIconWidgetParamsArray(),
            array(
                array(
                    'type' => 'textfield',
                    'name' => 'icon_text',
                    'title' => esc_html__('Icon Text', 'pxlz')
                ),
                array(
                    'type' => 'textfield',
                    'name' => 'link',
                ...
                array(
                    'type' => 'textfield',
                    'name' => 'icon_color',
                    'title' => esc_html__('Icon Color', 'pxlz')
                ),
                array(
                    'type' => 'textfield',
                    'name' => 'icon_hover_color',
                    'title' => esc_html__('Icon Hover Color', 'pxlz')
                ),
                array(
                    'type' => 'textfield',
                    'name' => 'icon_margin',
    ...
    public function widget($args, $instance) {
        ...
        $data = array();
        $data[] = !empty($instance['icon_hover_color']) ? pxlz_edgtf_get_inline_attr($instance['icon_hover_color'], 'data-hover-color') : '';
        $data = implode(' ', $data);
        ...
        if (!empty($instance['icon_size'])) {
            $holder_styles[] = 'font-size: ' . pxlz_edgtf_filter_px($instance['icon_size']) . 'px';
        }
        ...
        <a <?php pxlz_edgtf_class_attribute($holder_classes); ?> <?php echo wp_kses_post($data); ?> href="<?php echo esc_url($link); ?>" target="<?php echo esc_attr($target); ?>" <?php echo pxlz_edgtf_get_inline_style($holder_styles); ?>>
