...
if ($display_button === 'yes') {
    ...
    $button_styles = $this_object->getButtonStyles($params);
    ...
    <div class="edgtf-<?php echo esc_attr($class_name); ?>-add-to-cart <?php echo esc_attr($buttonSkinClass); ?>">
        <?php echo apply_filters('pxlz_edgtf_product_list_add_to_cart_link',
            sprintf('<a rel="nofollow" href="%s" data-quantity="%s" data-product_id="%s" data-product_sku="%s" class="%s" style="%s">%s</a>',
