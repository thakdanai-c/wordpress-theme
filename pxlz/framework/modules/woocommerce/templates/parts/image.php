...
if ($image_size === 'full') {
    ...
    $product_image_size = 'pxlz_edgtf_square';
} else if ($image_size === 'landscape') {
    $product_image_size = 'pxlz_edgtf_landscape';
} else if ($image_size === 'portrait') {
    $product_image_size = 'pxlz_edgtf_portrait';
...
if (has_post_thumbnail()) {
    the_post_thumbnail(apply_filters('pxlz_edgtf_product_list_image_size', $product_image_size));
}