...
<div class="edgtf-plc-holder <?php echo esc_attr($holder_classes) ?>">
    <div class="edgtf-plc-outer edgtf-owl-slider" <?php echo pxlz_edgtf_get_inline_attrs($holder_data); ?>>
        <?php if ($query_result->have_posts()): while ($query_result->have_posts()) : $query_result->the_post(); ?>
            <div class="edgtf-plc-item">
                <div class="edgtf-plc-image-outer">
                    <div class="edgtf-plc-image">
                        <?php pxlz_edgtf_get_module_template_part('templates/parts/image', 'woocommerce', '', $params); ?>
                    </div>
                    <div class="edgtf-plc-text" <?php echo pxlz_edgtf_get_inline_style($shader_styles); ?>>
